def check_for_force_names_change(stored_force_names_list, new_force_names_list):
    force_names_check_results_dict = {}
    
    change_in_force_names_number = len(new_force_names_list) - len(stored_force_names_list)
    if change_in_force_names_number > 0:
        force_names_check_results_dict["number_of_force_names"] = f"Increased by {change_in_force_names_number}"
        forces_added = []
        ...
        force_names_check_results_dict["number_of_force_names"] = f"Decreased by {change_in_force_names_number}"
        forces_removed = []
